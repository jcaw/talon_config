"""Ordinal numbers. "first", "second", "fourth", etc.

Extracted from the repeater, originally written by lunixbochs, pulled from
knausj's config:

https://github.com/knausj85/knausj_talon/blob/master/code/repeater.py
