"""Jetbrains module from `knausj_talon`.

Allows RPC via "Voice Code Idea" plugin for Jetbrains products.

knausj version:
https://github.com/knausj85/knausj_talon/blob/main/apps/jetbrains/jetbrains.py

Requires this plugin in the Jetbrains product:
https://plugins.jetbrains.com/plugin/10504-voice-code-idea-

Note this only covers the knausj actions. Action overrides added by myself are
in `jetbrains_actions.py`
...
"""
# windows
mod.apps.jetbrains = "app: idea64.exe"
mod.apps.jetbrains = "app: PyCharm64.exe"
mod.apps.jetbrains = "app: pycharm64.exe"
mod.apps.jetbrains = "app: webstorm64.exe"
mod.apps.jetbrains = """
os: mac
